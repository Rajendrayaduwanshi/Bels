...
//         <div class="info"><strong>Message:</strong>${message}</div>
...
//       to: "udaybhardwaj269@gmail.com", // Replace with your hospital's email
...
export async function POST(req: Request) {
  try {
    const { name, email, phone, subject, message, address } = await req.json();
    ...
    const adminHtmlContent = `
      ...
      <body>
          <div class="container">
              ...
              <div class="info"><strong>Name:</strong> ${name}</div>
              <div class="info"><strong>Email:</strong> ${email}</div>
              <div class="info"><strong>Phone:</strong> ${
                phone || "Not provided"
              }</div>
              <div class="info"><strong>Subject:</strong> ${
                subject || "No subject"
              }</div>
              <div class="info"><strong>Address:</strong> ${
                address || "No subject"
              }</div>
    ...
    // Create user confirmation email HTML content
    ...
    const adminInfo = await transporter.sendMail({
      from: process.env.EMAIL_USER,
      to: "Info.belshospital@gmail.com",
      subject: `New Contact Form Message: ${subject || "Contact Inquiry"}`,
