...
const carouselImages = [
  "/images/department/Onco-Surgery-1.jpg",
  "/images/department/Onco-Surgery-2.jpg",
  "/images/department/Onco-Surgery-3.jpg",
  "/images/department/Onco-Surgery-4.jpg",
  "/images/department/Onco-Surgery-5.jpg",
];
const page = () => {
  ...
  const services: ServiceSection[] = [
    {
      ...
      description:
        "At our hospital, we provide round-the-clock monitoring of vital signs, including heart rate, blood pressure, oxygen saturation, and respiratory rate. Our advanced monitoring technology ensures that any changes in the patient's condition are detected promptly, allowing for immediate intervention.",
    },
    {
      title: "Advanced Life Support",
      description:
        "Our critical care units are equipped with state-of-the-art technology and staffed by trained professionals to deliver advanced life support interventions. This includes mechanical ventilation, cardiac monitoring, and defibrillation, ensuring rapid response to emergencies.",
    },
    {
      title: "Specialized Nursing Care",
      description:
        "Our team of skilled critical care nurses is dedicated to providing personalized and compassionate care to our patients. Trained in critical care management, our nurses administer medications, monitor patient responses, and manage complex medical equipment.",
    },
  ];
      ...
      >
        <div className="container mx-auto">
          ...
          >
            ...
            <ChevronRight className="w-4 h-4" />
            <span> Oncology & Onco-surgery</span>
          </motion.div>
        </div>
      </motion.div>
